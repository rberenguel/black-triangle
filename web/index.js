...
var ASM_CONSTS = {
  88310: () => { if (document.fullscreenElement) return 1; },  
 88356: () => { return Module.canvas.width; },  
 88388: () => { return parseInt(Module.canvas.style.width); },  
 88436: () => { document.exitFullscreen(); },  
 88463: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 88535: () => { if (document.fullscreenElement) return 1; },  
 88581: () => { return Module.canvas.width; },  
 88613: () => { return screen.width; },  
 88638: () => { document.exitFullscreen(); },  
 88665: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 88859: () => { return window.innerWidth; },  
 88885: () => { return window.innerHeight; },  
 88912: () => { if (document.fullscreenElement) return 1; },  
 88958: () => { return Module.canvas.width; },  
 88990: () => { return parseInt(Module.canvas.style.width); },  
 89038: () => { if (document.fullscreenElement) return 1; },  
 89084: () => { return Module.canvas.width; },  
 89116: () => { return screen.width; },  
 89141: () => { return window.innerWidth; },  
 89167: () => { return window.innerHeight; },  
 89194: () => { if (document.fullscreenElement) return 1; },  
 89240: () => { return Module.canvas.width; },  
 89272: () => { return screen.width; },  
 89297: () => { document.exitFullscreen(); },  
 89324: () => { if (document.fullscreenElement) return 1; },  
 89370: () => { return Module.canvas.width; },  
 89402: () => { return parseInt(Module.canvas.style.width); },  
 89450: () => { document.exitFullscreen(); },  
 89477: ($0) => { Module.canvas.style.opacity = $0; },  
 89515: () => { return screen.width; },  
 89540: () => { return screen.height; },  
 89566: () => { return window.screenX; },  
 89593: () => { return window.screenY; },  
 89620: () => { return window.devicePixelRatio; },  
 89656: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 89709: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 89760: () => { Module.canvas.style.cursor = 'none'; },  
 89797: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 90053: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90104: () => { if (document.pointerLockElement) return 1; },  
 90151: () => { if (document.fullscreenElement) return 1; },  
 90197: () => { return window.innerWidth; },  
 90223: () => { return window.innerHeight; }
};
